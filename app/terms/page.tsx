...
export const metadata: Metadata = {
  title: "이용약관",
  description: "로셀 서비스 이용약관. AI 서비스 고지, 변호사법 준수, 개인정보 보호 등 서비스 이용 조건을 확인하세요.",
  openGraph: {
    title: "이용약관",
    description: "로셀 서비스 이용약관을 확인하세요.",
...
const SECTIONS = [
  {
    title: "제1조 (목적)",
    body: `이 약관은 (주)로셀(이하 "회사")가 운영하는 로셀 서비스(이하 "서비스")의 이용 조건 및 절차, 회사와 이용자의 권리·의무 및 책임 사항을 규정함을 목적으로 합니다.`,
  },
  {
    title: "제2조 (AI 서비스 고지)",
